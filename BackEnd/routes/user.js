...
router.get("/auth/google/callback" , passport.authenticate("google" , {
    failureRedirect: `${process.env.FRONTEND_URL || "https://verlo-8txq.onrender.com"}/users/login?error=google`
}),
    wrapAsync(async(req, res) => {
        ...
        await user.save();
        res.redirect(`${process.env.FRONTEND_URL || "https://verlo-8txq.onrender.com"}/oauth-success?redirect=${prevUrl}`);
    }
))
